        ...
        <div class="container">
          <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="offcanvas-icon d-block d-lg-none">
              <NuxtLink to="/#" class="nav-toggler"><i class="fal fa-bars"></i></NuxtLink>
            </div>

            <div class="header-category-menu d-none d-xl-block">
              <ul>
                <li class="has-submenu">
                  <NuxtLink to="/categories"><i class="fa fa-th me-2"></i>Categories</NuxtLink>
                  <ul class="submenu">
                    <li>
                      <a href="#">Design</a>
                      <ul class="submenu">
                        <li><NuxtLink to="/">Design Tools</NuxtLink></li>
                        <li><NuxtLink to="/">Photoshop mastering</NuxtLink></li>
                        <li><NuxtLink to="/">Adobe Xd Deisgn</NuxtLink></li>
                      </ul>
                    </li>
            ...
            <nav class="site-navbar ms-auto">
              <ul class="primary-menu">
                <li class="current">
                  ...
                  <ul class="submenu">
                    <li><NuxtLink to="/#">Home One</NuxtLink></li>
                    <li><NuxtLink to="/#">Home Two</NuxtLink></li>
                    <li><NuxtLink to="/#">Home Three</NuxtLink></li>
                    <li><NuxtLink to="/#">Home Four</NuxtLink></li>
                  </ul>
                </li>
